                      ...
                      <div class="swiper-wrapper "> 
                        @foreach($sliders as $key => $data)
                          <div class="swiper-slide">
                              <a href="single-post.html" class="img-bg d-flex align-items-end" style="background-image: url('{{ asset("projects/admin/img/slider/$data->imgUrl")}}');">
          ...
          <div class="row g-5">
              <div class="col-lg-4">
                  <div class="post-entry-1 lg">
                      <a href="single-post.html"><img src="{{ asset("projects/front/img/$firstblog->imgUrl")}}" alt="" class="img-fluid"></a>
                      <div class="post-meta"><span class="date">{{ $firstblog->category->name}}</span> <span class="mx-1">&bullet;</span> <span>{{$firstblog->created_at}}</span></div>
                      <h2><a href="single-post.html">{{$firstblog->title}}</a></h2>
                      <p class="mb-4 d-block">{{$firstblog->description}}</p>
                      <div class="d-flex align-items-center author">
                          <div class="photo"><img src="{{ asset("projects/front/img/$firstblog->imgUrl")}}" alt="" class="img-fluid"></div>
                          <div class="name">
                              <h3 class="m-0 p-0">{{$firstblog->authorName}}</h3>
                          </div>
                      </div>
                  </div>
              </div>
              <div class="col-lg-8">
                  <div class="row g-5">
                      {{-- @dd($blogs); --}}
                      <div class="col-lg-4 border-start custom-border costumerswippper">
                        @foreach ($blogs as $key => $data )
                            <div class="post-entry-1 post">
                                <a href="single-post.html"><img src="{{ asset('projects/front/img/post-landscape-1.jpg')}}" alt="" class="img-fluid"></a>
                                <div class="post-meta"><span class="date">{{ $data->title }}</span> <span class="mx-1">{{ $data->category->name }}&bullet;</span> <span>Jul 5th '22</span></div>
                                <h2><a href="single-post.html">{{ 'description' }}</a></h2>
                            </div>
                        @endforeach
                      </div>
              ...
              <div class="col-md-9">
                  ...
                  <div class="d-lg-flex post-entry-2">
                      <a href="single-post.html" class="me-4 thumbnail mb-4 mb-lg-0 d-inline-block">
                          <img src="{{ asset('projects/front/img/post-landscape-1.jpg')}}" alt="" class="img-fluid">
                      </a>
                      <div>
                          ...
                          <div class="d-flex align-items-center author">
                              <div class="photo"><img src="{{ asset('projects/front/img/post-landscape-1.jpg')}}" alt="" class="img-fluid"></div>
                              <div class="name">
  ...
  <script>
    ...
    const slide= document.querySelector(".costumerswippper");
    const div = document.createElement('div')
    div.className = 'col-lg-4 border-start custom-border';
    for (let i = (Math.ceil(post.length / 2)); i < post.length; i++){
        div.appendChild(post[i])
    }
    slide.parentNode.insertBefore(div,slide.nextSibling)
  </script>
