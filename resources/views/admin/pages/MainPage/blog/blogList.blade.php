        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
             <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{ route('slidercreate') }}">Create Blog</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  @foreach($blogs as $key => $data)
                    <tr>
                      <td><img style="height: 100px; width:100px; margin:auto;" src="{{ asset("projects/admin/img/Blog/".$data->imgUrl)}}" alt=""></td>
                      <td><img style="height: 100px; width:100px; margin:auto;" src="{{ asset("projects/admin/img/Blog/".$data->authorimgUrl)}}" alt=""></td>
                      <td>{{$data->title}}</td>
