      ...
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-between align-items-lg-center">
          ...
          <div class="col-lg-6">
            <div class="row">
              <div class="col-6">
                <img src="{{ asset('projects/front/img/post-landscape-1.jpg')}}" alt="" class="img-fluid mb-4">
              </div>
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img src="{{ asset('projects/front/img/post-landscape-1.jpg')}}" alt="" class="img-fluid rounded-circle w-50 mb-4">
          ...
          <div class="col-lg-4 text-center mb-5">
            <img ssrc="{{ asset('projects/front/img/post-landscape-1.jpg')}}" alt="" class="img-fluid rounded-circle w-50 mb-4">
            <h4>Jane Cooper</h4>
